package com.braincustom.fullstackproj.services.validation;
...
import com.braincustom.fullstackproj.resources.exceptions.FieldMessage;
import com.braincustom.fullstackproj.services.validation.utils.BR;
...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert, ClienteNewDTO> {
	...
	public boolean isValid(ClienteNewDTO objDto, ConstraintValidatorContext context) {
		...
		Cliente aux = reposi.findByEmail(objDto.getEmail());
		if(aux != null) {
